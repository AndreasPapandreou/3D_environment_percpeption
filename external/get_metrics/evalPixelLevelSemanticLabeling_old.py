...
# os.environ[
    # "CITYSCAPES_RESULTS"] = "/media/caramel/b776d2f6-4b47-4c15-8055-e488de9e9288/deeplabv3/training_logs/model_eval_val_for_metrics"
# os.environ["CITYSCAPES_DATASET"] = "/media/caramel/b776d2f6-4b47-4c15-8055-e488de9e9288/cityscapes"
...
# Cityscapes imports
# from evaluate import csHelpers
...
if CSUPPORT:
    try:
        from evaluate import addToConfusionMatrix
    except:
        CSUPPORT = False
...
def writeJSONFile(wholeData, config ,type):
    path = config['save_data']+config['save_stat']
    ensurePath(path)
    writeDict2JSON(wholeData, path + type + '_resultPixelLevelSemanticLabeling.json')
...
def printCategoryScores(scoreDict, instScoreDict, args):
    ...
    print(args.bold + "categories       IoU     " + args.nocol)
    print("--------------------------------")
    for categoryName in scoreDict:
        ...
        print("{:<14}: ".format(categoryName) + iouStr)


# Evaluate image lists pairwise.
def evaluateImgLists_sub(predictionImgList, groundTruthImgList, args, prediction_path, type):
    ...
    for i in range(len(predictionImgList)):
        predictionImgFileName = "/home/andreas/Documents/Caramel/caramelav/res/images/cropped_images/" + predictionImgList[i]
        groundTruthImgFileName = "/home/andreas/Desktop/thesisData/data_2/seg_gt_cropped/" + groundTruthImgList[i]
    ...
    # write result file
    if args.JSONOutput:
        writeJSONFile(allResultsDict, config, type)
...
# The main method
def evaluateImgLists(predictionImgList, groundTruthImgList, prediction_path, type):
    global args
    argv = sys.argv[1:]
    ...
    # groundTruthImgList = []
    #
    # path = '/media/beastv2/b776d2f6-4b47-4c15-8055-e488de9e9288/carlaData/carla/_out/resized_data/testannot_resized/'
    # predictionImgList.append(path + 'Town02_14_07_2020_18_29_24_008334.png')
    # groundTruthImgList.append(path + 'Town02_14_07_2020_18_29_24_008334.png')

    evaluateImgLists_sub(predictionImgList, groundTruthImgList, args, prediction_path, type)
